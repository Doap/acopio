...
?>
<script>
function ready<?php echo $product_id; ?>( jQuery ) {
        var product_id = '<?php echo $product_id; ?>';
        var quantity = '<?php echo $quantity; ?>';
        data = 'action=tcp_shopping_cart_actions&to_do=add&tcp_add_to_shopping_cart=&tcp_count%5B%5D=' . quantity . '&tcp_post_id%5B%5D=' . product_id;
        feedback.show();
...
$( document ).ready( ready<?php echo $product_id; ?> );
</script>
<?php
 }
}
