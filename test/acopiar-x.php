...
echo '<script src="../test/js/jquery.js"></script>';  
echo '<script src="../test/js/script.js"></script>';       
echo '<script src="../test/js/jquery-ui-1.8.17.custom.min.js"></script>';
echo ' <link rel="stylesheet" href="../test/css/style.css">';
...
//echo '<td><input type="number" name="cajillas[]" class="txtField" value="3"></td>';
echo '</tr>';
...
?>
   <div style="margin-left: 20%;margin-top: 5%;">
        ...
        <div class="entry-form" id="entry-form_<?php echo $_POST["products"][$i]; ?>">
                ...
                <table width="100%" border="0" cellpadding="4" cellspacing="0">
                        ...
                        <tr>
                                <td>Peso Bruto</td>
                                <td><input type="text" name="peso_bruto" autofocus="autofocus"></td>
                        </tr>
                        <tr>
                                <td>Cajillas</td>
