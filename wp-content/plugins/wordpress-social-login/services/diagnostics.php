...
<head>
	...
	<title>Doap Social Login Requirements Test</title>
	<style>
...
<body>
	<h1 style="text-align:center;">Doap Social Login Requirements Test</h1>
	...
	<p>
		<b>Doap Social Login requirements are</b>: 
	</p>
	<ul style="margin-left:40px;margin-top:0px;">
