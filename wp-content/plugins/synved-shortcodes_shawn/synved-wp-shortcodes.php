<?php
/*
Plugin Name: The DOAP Extras
Plugin URI: http://doap.com
Description: A complete set of shortcodes to add beautiful and useful elements that will spice up any site.
...
NO LIABILITY
In no event shall Doap be liable to you or any third party for any direct or indirect, special, incidental, or consequential damages in connection with or arising from errors, omissions, delays or other cause of action that may be attributed to your use of any product, support, services, information or software provided, including, but not limited to, lost profits or lost data, even if Synved Ltd. had been advised of the possibility of such damages.
*/
