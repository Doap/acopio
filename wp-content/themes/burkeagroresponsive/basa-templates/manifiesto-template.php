...
echo '<link rel="stylesheet" type="text/css" href="' . site_url('/manifiesto/') . 'styles.css" />';
echo '<script language="javascript" src="' . site_url('/manifiesto/') . 'orders.js" type="text/javascript"></script>';
